...
(function(exports) {
  ...
  var packageSet = function (packages$prime) {
      ...
      var render = function (packages) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("search")), Halogen_HTML_Events.onValueInput(function ($37) {
