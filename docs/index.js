      ...
      var go = function (acc) {
          return function (x) {
              ...
              if (v instanceof Data_Either.Left) {
                  var $43 = {};
                  for (var $44 in acc) {
                      if ({}.hasOwnProperty.call(acc, $44)) {
                          $43[$44] = acc[$44];
                      };
                  };
                  $43.left = Data_Semigroup.append(Data_Semigroup.semigroupArray)(acc.left)([ v.value0 ]);
                  return $43;
              };
              if (v instanceof Data_Either.Right) {
                  var $47 = {};
                  ...
                  $47.right = Data_Semigroup.append(Data_Semigroup.semigroupArray)(acc.right)([ v.value0 ]);
                  return $47;
              };
              throw new Error("Failed pattern match at Data.Filterable line 96, column 16 - line 98, column 50: " + [ v.constructor.name ]);
          };
      };
...
(function(exports) {
  ...
  var showPath = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Data.Path.Pathy line 523, column 1 - line 523, column 39: " + [ v.constructor.name ]);
  });
  ...
  var unsafePrintPath$prime = function (r) {
      ...
      var go = function (v) {
          ...
          throw new Error("Failed pattern match at Data.Path.Pathy line 407, column 5 - line 408, column 5: " + [ v.constructor.name ]);
      };
      return go;
  };
  ...
  var canonicalize$prime = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Path.Pathy line 392, column 1 - line 392, column 72: " + [ v.constructor.name ]);
  };
  var peel = function ($copy_v) {
      ...
      function $tco_loop(v) {
          ...
          throw new Error("Failed pattern match at Data.Path.Pathy line 293, column 1 - line 296, column 60: " + [ v.constructor.name ]);
      };
      while (!$tco_done) {
          $tco_result = $tco_loop($copy_v);
      };
  ...
  var appendPath = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Data.Path.Pathy line 237, column 1 - line 237, column 71: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
      ...
      return function (p2) {
          var relativeTo$prime = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Data.Path.Pathy line 444, column 3 - line 444, column 83: " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
...
(function(exports) {
  ...
  var printHost = function (v) {
      ...
      throw new Error("Failed pattern match at Data.URI.Host line 50, column 1 - line 50, column 26: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var printQuery = function (v) {
      var printPart = function (v1) {
          ...
          throw new Error("Failed pattern match at Data.URI.Query line 47, column 3 - line 47, column 51: " + [ v1.constructor.name ]);
      };
      if (v instanceof Data_List_Types.Nil) {
          return "";
      };
...
(function(exports) {
  ...
  exports["runParseURI"] = runParseURI;
...
(function(exports) {
  ...
  var newtypeRepo = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Repo);
  var href = function (v) {
      return Halogen_HTML_Properties.href(v);
  };
  exports["Repo"] = Repo;
  exports["href"] = href;
  exports["newtypeRepo"] = newtypeRepo;
})(PS["PackageSet.Repo"] = PS["PackageSet.Repo"] || {});
(function(exports) {
    "use strict";
  var Data_Newtype = PS["Data.Newtype"];
  var Halogen = PS["Halogen"];
  ...
  var newtypeVersion = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Version);
  exports["Version"] = Version;
  exports["render"] = render;
  exports["newtypeVersion"] = newtypeVersion;
})(PS["PackageSet.Version"] = PS["PackageSet.Version"] || {});
(function(exports) {
    "use strict";
  var Data_Function = PS["Data.Function"];
  var Data_Functor = PS["Data.Functor"];
  ...
  var Halogen_HTML_Elements = PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var PackageSet_Name = PS["PackageSet.Name"];
  var PackageSet_Repo = PS["PackageSet.Repo"];
  var PackageSet_Version = PS["PackageSet.Version"];        
  var Package = function (x) {
      return x;
  };
  var renderDependency = function (dep) {
      return Halogen_HTML_Elements.li_([ PackageSet_Name.renderPackage(dep) ]);
  };
  var packageRow = function (v) {
      return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package")) ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package-name")) ])([ Halogen_HTML_Elements.details([  ])([ Halogen_HTML_Elements.summary([  ])([ Halogen_HTML_Elements.a([ PackageSet_Repo.href(v.repo) ])([ PackageSet_Name.renderPackage(v.name) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Dependencies") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("dependencies")) ])(Data_Functor.map(Data_Functor.functorArray)(renderDependency)(v.dependencies)) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package-version")) ])([ PackageSet_Version.render(v.version) ]) ]);
  };
  ...
  exports["newtypePackage"] = newtypePackage;
})(PS["PackageSet.Package"] = PS["PackageSet.Package"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var PackageSet_Name = PS["PackageSet.Name"];
  var PackageSet_Package = PS["PackageSet.Package"];        
  var Search = (function () {
  ...
  var renderSearch = Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("search")), Halogen_HTML_Events.onValueInput(function ($7) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(search($7));
  ...
  var packageSet = function (setName) {
      return function (packages$prime) {
          var render = function (packages) {
              return Halogen_HTML_Elements.article_([ PackageSet_Name.renderSet(setName), renderSearch, PackageSet_Package.renderResults(packages) ]);
          };
          ...
          var $$eval = function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Filterable.filter(Data_Filterable.filterableArray)(function ($8) {
                  return Data_String.contains(Data_Newtype.wrap(Data_String.newtypePattern)(v.value0))(Data_Newtype.un(PackageSet_Name.newtypePackage)(PackageSet_Name.Package)((function (v1) {
                      return v1.name;
                  })(Data_Newtype.un(PackageSet_Package.newtypePackage)(PackageSet_Package.Package)($8))));
...
(function(exports) {
  ...
  var newtypeData = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Data);
  var functorData = new Data_Functor.Functor(function (f) {
      return function (m) {
          var $15 = {};
          for (var $16 in m) {
              if ({}.hasOwnProperty.call(m, $16)) {
                  $15[$16] = m[$16];
              };
          };
          $15.set = f(m.set);
  ...
  var foldableData = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function ($23) {
              return f((function (v) {
                  return v.set;
              })(Data_Newtype.unwrap(newtypeData)($23)));
          };
      };
  }, function (f) {
      return Data_Foldable.foldlDefault(foldableData)(f);
  }, function (f) {
      return Data_Foldable.foldrDefault(foldableData)(f);
  });
  var traversableData = new Data_Traversable.Traversable(function () {
      return foldableData;
  }, function () {
      return functorData;
  }, function (dictApplicative) {
      return Data_Traversable.sequenceDefault(traversableData)(dictApplicative);
  }, function (dictApplicative) {
      return function (f) {
          return function (v) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(function ($24) {
  ...
  exports["Data"] = Data;
  exports["functorData"] = functorData;
  exports["newtypeData"] = newtypeData;
  exports["foldableData"] = foldableData;
  exports["traversableData"] = traversableData;
})(PS["Raw"] = PS["Raw"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
...
(function(exports) {
  ...
  var parseSetURI = function (set) {
      var url = "https://cdn.rawgit.com/joneshf/purescript-package-sets/" + (set + "/packages.json");
      return Data_URI.runParseURI(url);
  };
      ...
      return function (name) {
          return function ($11) {
              return Control_Applicative.pure(dictApplicative)(Data_Newtype.wrap(PackageSet_Package.newtypePackage)(Data_Record.modify(new Data_Symbol.IsSymbol(function () {
                  return "version";
              }))()()(Data_Symbol.SProxy.value)(Data_Newtype.wrap(PackageSet_Version.newtypeVersion))(Data_Record.modify(new Data_Symbol.IsSymbol(function () {
                  return "repo";
              }))()()(Data_Symbol.SProxy.value)(Data_Newtype.wrap(PackageSet_Repo.newtypeRepo))(Data_Record.modify(new Data_Symbol.IsSymbol(function () {
                  return "dependencies";
              }))()()(Data_Symbol.SProxy.value)(Data_Functor.map(Data_Functor.functorArray)(Data_Newtype.wrap(PackageSet_Name.newtypePackage)))(Data_Record.modify(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))()()(Data_Symbol.SProxy.value)(Data_Newtype.wrap(PackageSet_Name.newtypePackage))(Data_Record.insert(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))(Type_Row.rowLacks()()()(Type_Row.rowLacking))()(Data_Symbol.SProxy.value)(name)($11)))))));
          };
      };
  };
  var loadData = function (parent) {
      return function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NonElementParentNode.getElementById("sets")(parent)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(function (v2) {
                  return v2.response;
              })(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(Data_URI.printURI(v.set))))(function (v2) {
                  var packages = Data_Foldable.foldMap(Data_Either.foldableEither)(Data_Monoid.monoidArray)(Data_StrMap.foldMap(Data_Monoid.monoidArray)(convert(Control_Applicative.applicativeArray)))(Simple_JSON.readJSON(Simple_JSON.readStrMap(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "dependencies";
                      ...
                      return "version";
                  }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.rowLacks()()()(Type_Row.rowLacking))())))(v2));
