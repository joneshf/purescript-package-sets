...
(function(exports) {
  ...
  var Text_Parsing_StringParser = PS["Text.Parsing.StringParser"];        
  var Nope = (function () {
      function Nope(value0) {
          this.value0 = value0;
      };
      Nope.create = function (value0) {
          return new Nope(value0);
      };
      return Nope;
  })();
  ...
  var packageSet = function (packages$prime) {
      var render = function (packages) {
          return Halogen_HTML_Elements.pre_([ Halogen_HTML_Core.text(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(packages)) ]);
      };
