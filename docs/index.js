...
(function(exports) {
  ...
  var packageSetURL = function (set) {
  ...
  var packageSet = function (packages$prime) {
      var receiver = function (v) {
          return Data_Maybe.Nothing.value;
      };
      var packageRow = function (v) {
          return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.repo) ])([ Halogen_HTML_Core.text(v.name) ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(v.version) ]) ]);
      };
      var render = function (packages) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(function ($37) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(search($37));
          }), Halogen_HTML_Properties.placeholder("Search"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value) ]), Halogen_HTML_Elements.table_([ Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("name") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("version") ]) ]) ]), Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(packageRow)(packages)) ]) ]);
      };
      var initialState = function (v) {
          return packages$prime;
      };
      var $$eval = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Filterable.filter(Data_Filterable.filterableArray)(function ($38) {
              return Data_String.contains(Data_Newtype.wrap(Data_String.newtypePattern)(v.value0))((function (v1) {
                  return v1.name;
              })(Data_Newtype.un(newtypePackage)(Package)($38)));
  ...
  var loadData = function (parent) {
      return function (url) {
          return function (ident) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NonElementParentNode.getElementById(ident)(parent)))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(function (v1) {
                      return v1.response;
                  })(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(Data_URI.printURI(url))))(function (v1) {
                      var packages = (function () {
                          var v2 = Simple_JSON.readJSON(readForeignPackageSetPackage)(v1);
                          if (v2 instanceof Data_Either.Right) {
                      ...
                      return Data_Foldable.for_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(v)(DOM_Classy_Element.fromElement(DOM_Classy_Element.isElementHTMLElement)))(Halogen_VDom_Driver.runUI(packageSet(packages))(Data_Unit.unit));
                  });
              });
          };
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document)))(function (v) {
      ...
      var v1 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(packageSetURL)([ "psc-0.11.6", "purerl-0.11.6" ]);
      if (v1 instanceof Data_Either.Right && v1.value0.length === 2) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(loadData(parent)(v1["value0"][0])("psc-container"))(function () {
              return loadData(parent)(v1["value0"][1])("purerl-container");
          });
      };
      return Control_Monad_Aff_Console.log("whoops");
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
