...
(function(exports) {
  ...
  var parseSetURI = function (v) {
      ...
      return Data_Functor.mapFlipped(Data_Either.functorEither)(Data_URI.runParseURI(url))(function ($13) {
