...
})(PS["Data.ArrayBuffer.DataView"] = PS["Data.ArrayBuffer.DataView"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Data.ArrayBuffer.DataView"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
...
(function(exports) {
  ...
  var Data_Maybe = PS["Data.Maybe"];
  var Prelude = PS["Prelude"];
  exports["asUint8Array"] = $foreign.asUint8Array;
})(PS["Data.ArrayBuffer.Typed"] = PS["Data.ArrayBuffer.Typed"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
...
(function(exports) {
  ...
  var eqSet = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  var ordSet = new Data_Ord.Ord(function () {
      return eqSet;
  }, function (x) {
      return function (y) {
  ...
  var eqPackage = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  var ordPackage = new Data_Ord.Ord(function () {
      return eqPackage;
  }, function (x) {
      return function (y) {
          return Data_Ord.compare(Data_Ord.ordString)(x)(y);
...
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["SQLJS"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Uncurried = PS["Control.Monad.Eff.Uncurried"];
  var Data_ArrayBuffer_Types = PS["Data.ArrayBuffer.Types"];
  var Data_Foreign = PS["Data.Foreign"];
  var Data_Unit = PS["Data.Unit"];        
  var $$new = Control_Monad_Eff_Uncurried.runEffFn1($foreign.new_);
  var exec = Control_Monad_Eff_Uncurried.runEffFn2($foreign.exec_);
  exports["exec"] = exec;
  exports["new"] = $$new;
})(PS["SQLJS"] = PS["SQLJS"] || {});
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document)))(function (v) {
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableArrayBuffer)(sqliteURI))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff["liftEff'"](function __do() {
              ...
              var v3 = SQLJS.exec(packageSQL)(v2)();
              return Control_Monad_Except.runExcept((function () {
                  if (v3.length === 1) {
                      return Data_Traversable["for"](Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(Data_Traversable.traversableArray)(v3[0].values)(function (v4) {
                          if (v4.length === 4) {
                              var dependencies = [  ];
                  ...
                  return Data_Foreign.fail(new Data_Foreign.ForeignError("expected one result"));
              })());
          }))(function (v2) {
              ...
              if (v2 instanceof Data_Either.Right && v2.value0 instanceof Data_Either.Left) {
                  return Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_List_Types.foldableNonEmptyList)(function ($41) {
                      return Control_Monad_Aff_Console.log(Data_Foreign.renderForeignError($41));
                  })(v2.value0.value0);
              };
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NonElementParentNode.getElementById("sets")(parent)))(function (v3) {
                      return Data_Foldable.for_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(v3)(DOM_Classy_Element.fromElement(DOM_Classy_Element.isElementHTMLElement)))(function (el) {
                          return Data_Foldable.for_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(Data_Map.toUnfoldable(Data_Unfoldable.unfoldableArray)(packageSets))(function (v4) {
                              return Halogen_VDom_Driver.runUI(PackageSet.packageSet(v4.value0)(Data_Array.sortWith(PackageSet_Name.ordPackage)(function ($42) {
                                  return (function (v5) {
                                      return v5.name;
                                  })(Data_Newtype.un(PackageSet_Package.newtypePackage)(PackageSet_Package.Package)($42));
                              })(v4.value1)))(Data_Unit.unit)(el);
                          });
                      });
                  });
              };
              throw new Error("Failed pattern match at Main line 62, column 3 - line 70, column 86: " + [ v2.constructor.name ]);
          });
      });
  }));
  exports["main"] = main;
