...
(function(exports) {
  ...
  var newtypePackageSetData = new Data_Newtype.Newtype(function (n) {
      return n;
  }, PackageSetData);
  ...
  var packageSet = function (v) {
      return function (packages$prime) {
          ...
          var $$eval = function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Filterable.filter(Data_Filterable.filterableArray)(function ($60) {
                  return Data_String.contains(Data_Newtype.wrap(Data_String.newtypePattern)(v1.value0))((function (v2) {
                      return v2.name;
                  })(Data_Newtype.un(newtypePackage)(Package)($60)));
                  ...
                  var packages = (function () {
                      ...
                      if (v3 instanceof Data_Either.Right) {
                          return Data_StrMap.foldMap(Data_Monoid.monoidArray)(function (name) {
                              return function (v4) {
                                  return [ Data_Newtype.wrap(newtypePackage)({
                                      name: name, 
                                      repo: v4.repo, 
                                      version: v4.version
                                  }) ];
  ...
  var functorPackageSetData = new Data_Functor.Functor(function (f) {
      return function (m) {
          var $51 = {};
          for (var $52 in m) {
              if ({}.hasOwnProperty.call(m, $52)) {
                  $51[$52] = m[$52];
              };
          };
          $51.set = f(m.set);
  ...
  var foldablePackageSetData = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function ($61) {
              return f((function (v) {
                  return v.set;
              })(Data_Newtype.unwrap(newtypePackageSetData)($61)));
          };
      };
  }, function (f) {
      return Data_Foldable.foldlDefault(foldablePackageSetData)(f);
  }, function (f) {
      return Data_Foldable.foldrDefault(foldablePackageSetData)(f);
  });
  var traversablePackageSetData = new Data_Traversable.Traversable(function () {
      return foldablePackageSetData;
  }, function () {
      return functorPackageSetData;
  }, function (dictApplicative) {
      return Data_Traversable.sequenceDefault(traversablePackageSetData)(dictApplicative);
  }, function (dictApplicative) {
      return function (f) {
          return function (v) {
              return Data_Functor.mapFlipped((dictApplicative.Apply0()).Functor0())(f(v.set))(function ($62) {
                  return Data_Newtype.wrap(newtypePackageSetData)((function (v1) {
                      return {
                          name: v.name, 
                          set: v1
                      };
  ...
  var parsePackageSet = (function () {
      var makeUrl = function (version) {
          return "https://cdn.rawgit.com/joneshf/purescript-package-sets/" + (version + "/packages.json");
      };
      return Data_Traversable.traverse(traversablePackageSetData)(Data_Either.applicativeEither)(function ($63) {
          return Data_URI.runParseURI(makeUrl($63));
      });
  })();
