...
(function(exports) {
  ...
  var packageRow = function (v) {
      return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package")) ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package-name")) ])([ Halogen_HTML_Elements.details([  ])([ Halogen_HTML_Elements.summary([  ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.repo) ])([ PackageSet_Name.renderPackage(v.name) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Dependencies") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("dependencies")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(v.dependencies)(function (dep) {
...
(function(exports) {
  ...
  var Text_Parsing_StringParser = PS["Text.Parsing.StringParser"];
  var Type_Row = PS["Type.Row"];        
  var wrapVersion = Data_Record.modify(new Data_Symbol.IsSymbol(function () {
      return "version";
  }))()()(Data_Symbol.SProxy.value)(Data_Newtype.wrap(PackageSet_Version.newtypeVersion));
  var sets = [ {
      name: "psc", 
      set: "psc-0.11.6"
  }, {
          ...
          return function (dictRowLacks) {
              return function (name) {
                  return function ($$package) {
                      return Data_Newtype.wrap(dictNewtype1)(Data_Record.insert(new Data_Symbol.IsSymbol(function () {
                          return "name";
                      }))(dictRowLacks)()(Data_Symbol.SProxy.value)(Data_Newtype.wrap(dictNewtype)(name))($$package));
                  };
              };
          };
      };
                  ...
                  var packages = (function () {
                      ...
                      if (v3 instanceof Data_Either.Right) {
                          return Data_StrMap.foldMap(Data_Monoid.monoidArray)(function (name) {
                              return function ($$package) {
                                  return [ insertName(PackageSet_Name.newtypePackage)(PackageSet_Package.newtypePackage)(Type_Row.rowLacks()()()(Type_Row.rowLacking))(name)(wrapVersion($$package)) ];
                              };
                          })(v3.value0);
                      };
                      return [  ];
