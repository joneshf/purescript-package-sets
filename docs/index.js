...
(function(exports) {
  ...
  var packageSet = function (packages$prime) {
      var render = function (packages) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(function (str) {
              return Data_Maybe.Just.create(new Search(str, Data_Unit.unit));
      ...
      var $$eval = function (v) {
          var packages = Data_Filterable.filter(Data_Filterable.filterableArray)(Data_String.contains(Data_Newtype.wrap(Data_String.newtypePattern)(v.value0)))(packages$prime);
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(packages))(function () {
          ...
          return function (ident) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NonElementParentNode.getElementById(ident)(parent)))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(function (v1) {
                      return v1.response;
                  })(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)(Data_URI.printURI(url))))(function (v1) {
                      var packages = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(Data_StrMap.keys)(Data_Argonaut_Core.toObject(v1)));
