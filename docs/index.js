...
(function(exports) {
  ...
  var packageRow = function (v) {
      ...
      })) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package-version")) ])([ PackageSet_Version.render(v.version) ]) ]);
  };
...
(function(exports) {
  ...
  var readForeignPackageSet = Simple_JSON.readStrMap(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "dependencies";
  ...
  var parseSetURI = function (v) {
      ...
      return Data_Functor.mapFlipped(Data_Either.functorEither)(Data_URI.runParseURI(url))(function ($16) {
  ...
  exports["readForeignPackageSet"] = readForeignPackageSet;
})(PS["Raw"] = PS["Raw"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NonElementParentNode.getElementById("sets")(parent)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(function (v2) {
                  ...
                  var packages = (function () {
                      var v3 = Simple_JSON.readJSON(Raw.readForeignPackageSet)(v2);
                      if (v3 instanceof Data_Either.Right) {
                          return Data_StrMap.foldMap(Data_Monoid.monoidArray)(convert(Control_Applicative.applicativeArray))(v3.value0);
                      };
                      return [  ];
                  })();
