      ...
      return function (dictRowLacks) {
          return function (name) {
              return function ($$package) {
                  return Data_Newtype.wrap(dictNewtype)(Data_Record.insert(new Data_Symbol.IsSymbol(function () {
                      return "name";
                  }))(dictRowLacks)()(Data_Symbol.SProxy.value)(name)($$package));
              };
          };
      };
  };
                  ...
                  var packages = (function () {
                      ...
                      if (v3 instanceof Data_Either.Right) {
                          return Data_StrMap.foldMap(Data_Monoid.monoidArray)(function (name) {
                              return function ($$package) {
                                  return [ insertName(PackageSet_Package.newtypePackage)(Type_Row.rowLacks()()()(Type_Row.rowLacking))(name)($$package) ];
                              };
                          })(v3.value0);
                      };
                      return [  ];
