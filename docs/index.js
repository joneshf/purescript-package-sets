...
(function(exports) {
  ...
  var packageSet = function (packages$prime) {
      var render = function (packages) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(function ($24) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(search($24));
          }), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value) ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Core.text(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(packages)) ]) ]);
      };
      ...
      var $$eval = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Filterable.filter(Data_Filterable.filterableArray)(Data_String.contains(Data_Newtype.wrap(Data_String.newtypePattern)(v.value0)))(packages$prime)))(function () {
          ...
          return function (ident) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NonElementParentNode.getElementById(ident)(parent)))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(function (v1) {
                      ...
                      var packages = Data_Either.either(Data_Function["const"]([  ]))(function ($25) {
                          return Data_StrMap.keys(Data_Newtype.un(newtypePackageSetPackage)(PackageSetPackage)($25));
                      })(Simple_JSON.readJSON(readForeignPackageSetPackage)(v1));
