...
(function(exports) {
  ...
  var packageRow = function (v) {
      return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package")) ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("package-name")) ])([ Halogen_HTML_Elements.details([  ])([ Halogen_HTML_Elements.summary([  ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.repo) ])([ PackageSet_Name.renderName(v.name) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Dependencies") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("dependencies")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(v.dependencies)(function (dep) {
  ...
  var packageSet = function (setName) {
      return function (packages$prime) {
          var render = function (packages) {
              return Halogen_HTML_Elements.article_([ PackageSet_Name.renderName(setName), renderSearch, PackageSet_Package.renderResults(packages) ]);
          };
          ...
          var $$eval = function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Filterable.filter(Data_Filterable.filterableArray)(function ($8) {
                  return Data_String.contains(Data_Newtype.wrap(Data_String.newtypePattern)(v.value0))(Data_Newtype.un(PackageSet_Name.newtypeName)(PackageSet_Name.Name)((function (v1) {
                      return v1.name;
                  ...
                  var packages = (function () {
                      ...
                      if (v3 instanceof Data_Either.Right) {
                          return Data_StrMap.foldMap(Data_Monoid.monoidArray)(function (name) {
                              return function ($$package) {
                                  return [ insertName(PackageSet_Name.newtypeName)(PackageSet_Package.newtypePackage)(Type_Row.rowLacks()()()(Type_Row.rowLacking))(name)($$package) ];
                              };
                          })(v3.value0);
                      };
                      return [  ];
